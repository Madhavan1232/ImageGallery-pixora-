  ...
  return (
    <>
      <div className="page-header">
        <h1 className="page-header__title">Your Bookmarks</h1>
      ...
      <div className="gallery-wrap" style={{ paddingTop: 0 }}>
        {loading ? (
          ...
          <div className="empty-state">
            <Bookmark size={56} style={{ opacity: 0.15, marginBottom: 20 }} />
            <h3 className="empty-state__title">No bookmarks yet</h3>
            <p className="empty-state__sub">
              Browse the gallery and hit the bookmark icon on any photo to save it here.
            </p>
          </div>
        ) : (
          <Masonry
